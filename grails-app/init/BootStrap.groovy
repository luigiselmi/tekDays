...
class BootStrap {
    ...
    def init = { servletContext ->
				new TekUser(fullName: 'John Doe', 
					...
					He has worked with every programming language known 
					to man and has settled on Groovy. In his spare time, 
				...
				new TekUser(fullName: 'John Deere', 
					...
					bio: '''John is a top notch Perl programmer and a pretty good hand
					around the farm. If he can't program it he can plow it!''').save()
				...
				def event1 = new TekEvent(name: 'Gateway Code Camp', 
							  ...
							  description: '''This conference will bring coders from across platforms.'''
							  )
